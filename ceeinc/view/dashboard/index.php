                ...
                <div class="card">
                  ...
                  <div class="card-body pb-0 total-sells">
                    <div class="d-flex align-items-center gap-3"> 
                      <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/icon/coin1.png" alt="icon"></div>
              ...
              <div class="col-xl-3 col-sm-6"> 
                <div class="card">
                  ...
                  <div class="card-body pb-0 total-sells-2">
                    <div class="d-flex align-items-center gap-3"> 
                      <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/icon/shopping1.png" alt="icon"></div>
                      <div class="flex-grow-1">
                        <div class="d-flex align-items-center gap-2"> 
                          <h2>78,596</h2>
                          <div class="d-flex total-icon">
              ...
              <div class="col-xl-3 col-sm-6"> 
                <div class="card">
                  ...
                  <div class="card-body pb-0 total-sells-3">
                    <div class="d-flex align-items-center gap-3"> 
                      <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/icon/sent1.png" alt="icon"></div>
                      <div class="flex-grow-1">
                        <div class="d-flex align-items-center gap-2"> 
                          <h2>95,789</h2>
                          <div class="d-flex total-icon">
              ...
              <div class="col-xl-3 col-sm-6"> 
                <div class="card">
                  ...
                  <div class="card-body pb-0 total-sells-4">
                    <div class="d-flex align-items-center gap-3"> 
                      <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/icon/revenue1.png" alt="icon"></div>
                      <div class="flex-grow-1">
                        <div class="d-flex align-items-center gap-2"> 
                          <h2>41,954</h2>
                          <div class="d-flex total-icon">
                      ...
                      <table class="table display" id="recent-orders" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/1.png" alt=""></div>
                            ...
                            <td class="customer-img">  
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/6.png" alt=""></div>
                                <div class="flex-grow-1">
                                  <h6>Leonie Green  </h6>
                                </div>
                              </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/2.png" alt=""></div>
                                <div class="flex-grow-1"><a href="checkout.html">
                            ...
                            <td class="customer-img">  
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/8.png" alt=""></div>
                                <div class="flex-grow-1">
                                  <h6>Peter White</h6>
                                </div>
                              </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/3.png" alt=""></div>
                                <div class="flex-grow-1"><a href="checkout.html">
                            ...
                            <td class="customer-img">  
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/7.png" alt=""></div>
                                <div class="flex-grow-1">
                                  <h6>Ruby Yang </h6>
                                </div>
                              </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/4.png" alt=""></div>
                                <div class="flex-grow-1"><a href="checkout.html">
                  ...
                  <div class="card-body pt-0"> 
                    <ul class="recent-customers"> 
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/1.png" alt=""></div>
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/2.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/3.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                            <h5>Seonil Jang</h5></a>
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/4.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                            <h5>Joohee Min</h5></a>
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/5.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                            <h5>Soojung Kin</h5></a>
                        ...
                        <ul> 
                          <li> 
                            <div class="d-flex gap-2">
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-primary" href="<?= BASE_URL ?>dashboard_assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>United States</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2">
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-secondary" href="<?= BASE_URL ?>dashboard_assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Romania</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2"> 
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-warning" href="<?= BASE_URL ?>dashboard_assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Austalia</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2"> 
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-tertiary" href="<?= BASE_URL ?>dashboard_assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Germany</h6>
                          ...
                          <li>
                            <div class="d-flex gap-2"> 
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-success" href="<?= BASE_URL ?>dashboard_assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Africa</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2">
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-danger" href="<?= BASE_URL ?>dashboard_assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Europe</h6>
                          ...
                          <div class="row"> 
                            <div class="col-3 product-thumbnail">
                              <div class="pro-slide-right">
                                <div class="mt-4">
                                  <div class="slide-box"><img class="img-fluid" src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/slider/1.png" alt=""></div>
                                </div>
                                <div>
                                  <div class="slide-box"><img class="img-fluid" src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/slider/2.png" alt=""></div>
                                </div>
                                <div>
                                  <div class="slide-box"><img class="img-fluid" src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/slider/3.png" alt=""></div>
                                </div>
                              </div>
                            </div>
                            <div class="col-9 px-0 product-main">
                              <div class="pro-slide-single">
                                <div> <img class="img-fluid" src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/slider/4.png" alt=""></div>
                                <div><img class="img-fluid" src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/slider/5.png" alt=""></div>
                                <div><img class="img-fluid" src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/slider/6.png" alt=""></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <table class="table display" id="seller-month" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/9.png" alt=""></div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/10.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/11.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= BASE_URL ?>dashboard_assets/images/dashboard-3/user/12.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
