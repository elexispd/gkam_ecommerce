        ...
        <div class="card">
          ...
          <div class="card-body">
            <form class="row g-3 needs-validation custom-input" id="productForm" enctype="multipart/form-data" novalidate method="post" action="<?= BASE_URL ?>product/store">
              ...
              <span class="text-danger">*</span><label class="form-label" for="validationTooltip01">Product Title</label>
                <input class="form-control" id="validationTooltip01" type="text" name="title" required>
              </div>
              <div class="col-md-6 position-relative">
              <span class="text-danger">*</span><label class="form-label" for="validationTooltip011">Category</label>
              ...
              <div class="col-md-3 position-relative">
                <label class="form-label" for="validationTooltip0231">Old Price</label>
                <input class="form-control" id="validationTooltip0231" type="number" step="0.01" name="old_price">
              </div>
              <div class="col-md-3 position-relative">
              <span class="text-danger">*</span><label class="form-label" for="validationTooltip0332">Shipping</label>
                <input class="form-control" id="validationTooltip0332" type="number" name="shipping" required>
              </div>
              <div class="col-md-3 position-relative">
                <label class="form-label" for="validationTooltip03322">Sub Shipping</label>
                <input class="form-control" id="validationTooltip03322" type="number" name="sub_shipping" required>
              </div>
              <div class="col-md-6 position-relative">
                <span class="text-danger">*</span><label class="form-label" for="validationTooltip03">Stock Quantity</label>
                <input class="form-control" id="validationTooltip03" type="number" name="stock" required>
              </div>
              <div class="col-md-6 position-relative">
                <span class="text-danger">*</span><label class="form-label" for="validationTooltip031">Min Quantity</label>
                <input class="form-control" id="validationTooltip031" type="number" name="min_quantity" required>
              </div>
              <div class="col-12">
                <span class="text-danger">*</span><label class="form-label" for="exampleFormControlTextarea1">Description</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" name="description" rows="3" required></textarea>
              </div>
              <div class="col-12">
                <label for="" class="text-muted">First will be used as the thumbnail</label><br>
