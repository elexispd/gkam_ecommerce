                            ...
                            <div class="cat-toggle">
                                ...
                                <div class="cat__menu">
                                    <nav id="mobile-menu">
                                        <ul>
                                            <li>
                                                <a href="product.html">All Categories <i
                                            ...
                                            <li>
                                                <a href="product.html">New Arrivals <i
                                                        class="far fa-angle-down"></i></a>
                                                <ul class="submenu">
                            ...
                            <div class="col-xl-9 custom-col-9 col-lg-8">
                                <div class="slider__inner slider-active">
                                    <div class="single-slider w-img">
                                        <img id="sliderImage" src="assets/img/slider/01/slider-1.jpg" alt="slider" loading="lazy">
                                    </div>
                                    <div class="single-slider w-img">
                                        <img id="sliderImage" src="assets/img/slider/01/slider-2.jpg" alt="slider" loading="lazy">
                                    </div>
                                    <div class="single-slider w-img">
                                        <img src="assets/img/slider/01/slider-3.jpg" alt="slider" loading="lazy">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="tab-content" id="best-sell">
                            <div class="tab-pane fade show active" id="new" role="tabpanel" aria-labelledby="new-tab">
                                ...
                                <?php 
                                    $best_sellers =  product_model::getBestProducts();
                                    ...
                                    <div class="product__item white-bg">
                                        ...
                                        <div class="product__content text-center">
                                            <h6 class="product-name">
                                                <a class="product-item-link" href="product-details.html"> <?= $best_seller["title"] ?> </a>
                                            </h6>
                                            <div class="rating">
                                                <ul>
                                ...
                                <ul class="nav nav-tabs" id="flast-sell-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="computer-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true">computer</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="cell-tab" data-bs-toggle="tab"
                                            data-bs-target="#cell" type="button" role="tab" aria-selected="false">Cell
                                            Phones</button>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-8.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-4.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                                ...
                                                <div class="product__content text-center">
                                                    <h6 class="product-name">
                                                        <a class="product-item-link" href="product-details.html">
                                                            Capacitive Touch Screen 22 Inch LCD Display Monitor</a>
                                                    </h6>
                                                    <div class="rating">
                                                        <ul>
                                                            <li><a href="#"><i class="far fa-star"></i></a></li>
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-1.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-5.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb product__thumb-big pb-15 p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-24.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-13.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-16.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-11.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                            ...
                                            <div class="product__item white-bg">
                                                <div class="product__thumb p-relative">
                                                    <a href="product-details.html" class="w-img">
                                                        ...
                                                        <img class="second-img"
                                                            src="assets/img/shop/product/product-15.jpg" alt="product">
                                                    </a>
                                                    <div class="product__action p-absolute">
                                                        <ul>
                                                            <li><a href="#" title="Add to Wishlist"><i
                                                ...
                                                <div class="product__content text-center">
                                                    <h6 class="product-name">
                                                        <a class="product-item-link" href="product-details.html">
                                                            Samsung Grand 2 2/64GB, with Charger </a>
                                                    </h6>
                                                    <div class="rating">
                                                        <ul>
                                                            <li><a href="#"><i class="far fa-star"></i></a></li>
                            ...
                            <div class="product__item-wrapper">
                                ...
                                <div class="product__item white-bg d-flex mb-20">
                                    <div class="product__thumb product__thumb-sale p-relative">
                                        <a href="product-details.html" class="w-img">
                                            <img src="assets/img/shop/product/product-14.jpg" alt="product">
                                            <img class="second-img" src="assets/img/shop/product/product-1.jpg"
                                                alt="product">
                                        </a>
                                    </div>
                                    <div class="product__content">
                            ...
                            <div class="product__item-wrapper">
                                <div class="product__item white-bg d-flex mb-20">
                                    <div class="product__thumb product__thumb-sale p-relative">
                                        <a href="product-details.html" class="w-img">
                                            ...
                                            <img class="second-img" src="assets/img/shop/product/product-7.jpg"
                                                alt="product">
                                        </a>
                                    </div>
                                    <div class="product__content">
                                ...
                                <div class="product__item white-bg d-flex mb-20">
                                    <div class="product__thumb product__thumb-sale p-relative">
                                        <a href="product-details.html" class="w-img">
                                            <img src="assets/img/shop/product/product-15.jpg" alt="product">
                                            <img class="second-img" src="assets/img/shop/product/product-24.jpg"
                                                alt="product">
                                        </a>
                                    </div>
                                    <div class="product__content">
                                ...
                                <div class="product__item white-bg d-flex mb-20">
                                    <div class="product__thumb product__thumb-sale p-relative">
                                        <a href="product-details.html" class="w-img">
                                            ...
                                            <img class="second-img" src="assets/img/shop/product/product-18.jpg"
                                                alt="product">
                                        </a>
                                    </div>
                                    <div class="product__content">
                            ...
                            <div class="product__item-wrapper">
                                    ...
                                    <div class="product__content">
                                        <h6 class="product-name">
                                            <a class="product-item-link" href="product-details.html">Capacitive Touch
                                                Screen 22 Inch Advertising LCD Display Monitor </a>
                                        </h6>
                                        <div class="rating">
                                            <ul>
                                                <li><a href="#"><i class="far fa-star"></i></a></li>
                                ...
                                <div class="product__item white-bg d-flex mb-20">
                                    <div class="product__thumb product__thumb-sale p-relative">
                                        <a href="product-details.html" class="w-img">
                                            <img src="assets/img/shop/product/product-20.jpg" alt="product">
                                            <img class="second-img" src="assets/img/shop/product/product-11.jpg"
                                                alt="product">
                                        </a>
                                    </div>
                                    <div class="product__content">
